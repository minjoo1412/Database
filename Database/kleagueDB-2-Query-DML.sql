...
SELECT	TIMESTAMPDIFF(YEAR, '2000-08-02', '2019-05-15'),
		YEAR('2019-05-15') - YEAR('2000-08-02');
...
SELECT	COUNT(TEAM_ID), COUNT(POSITION), COUNT(BACK_NO), COUNT(HEIGHT)
FROM	PLAYER;
...
GROUP 	BY POSITION;						/* 에러: WHERE 절에는 집단 함수를 사욜할 수 없음. */
